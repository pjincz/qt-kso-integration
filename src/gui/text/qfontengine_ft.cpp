...
quint32 qt_glyphTransposition[2048] = {
    ...
    0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,
    0xf00c00ff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xefffffff,
    0xffffffff, 0xffffff7f, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,
    0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,
    0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,
    0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,
    0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,
    ...
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0xffff0000, 0xffff0000, 0xffffffff, 0x0000ffff, 0x00000000, 0x00000000, 0x00000000, 0x00000000,
    0xffffdfff, 0x57ffffff, 0xbfffffff, 0xffffffe1, 0xffffffff, 0xffffffff, 0xffffffff, 0xffffffff,
};
...
void QFreetypeFace::initGlyphToUnicodeMap()
{
    if (unicode_map && face->num_glyphs <= (1<<16)) {
        glyphToUnicode.resize(face->num_glyphs);
        qMemSet(glyphToUnicode.data(), 0,  glyphToUnicode.size() * 2);
        ...
        while (gindex != 0)
        {
            glyphToUnicode[gindex] = charcode;
...
bool QFreetypeFace::rotateInVerticalMode(glyph_t glyphIndex)
{
    uint ucs2 = glyphToUnicode.value(glyphIndex, 0);
    uint i = ucs2 >> 5;
    uint mask = 1 << (ucs2 & 31);
    return (qt_glyphTransposition[i] & mask);
}
...
bool QFontEngineFT::init(FaceId faceId, bool antialias, GlyphFormat format)
{
    ...
    if (fontDef.verticalMetrics)
        freetype->initGlyphToUnicodeMap();
...
//     Q_ASSERT(freetype->lock == 1);
    ...
    if (fontDef.verticalMetrics && freetype->rotateInVerticalMode(glyph)) {
...
bool QFontEngineFT::loadGlyphs(QGlyphSet *gs, glyph_t *glyphs, int num_glyphs, GlyphFormat format)
{
    ...
    if (fontDef.verticalMetrics) {
        ...
        for (int i = 0; i < glyphsToLoad.size(); ++i) {
            rotation = freetype->rotateInVerticalMode(glyphsToLoad[i]);
                                    ...
                                    QPainterPath *path, QTextItem::RenderFlags)
{
    ...
    if (fontDef.verticalMetrics) {
        ...
        for (int gl = 0; gl < numGlyphs; gl++) {
            ...
            rotation = freetype->rotateInVerticalMode(glyph);
